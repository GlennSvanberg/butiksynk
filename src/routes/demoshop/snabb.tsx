...
function SnabbListingPage() {
  ...
  }, [preview, generateUploadUrl, createProductFromPhotoCapture])
      ...
      <div className="mx-auto max-w-lg px-4 py-8 sm:px-6">
        <header className="mb-6">
          ...
          <p className="mt-2 text-sm text-brand-dark/75">
            ...
            fortsätter fota. Granska listan i demoshop när du vill.
          </p>
        </header>
        ...
        <div className="flex flex-col gap-4 rounded-lg border border-brand-dark/8 bg-brand-surface p-5 shadow-sm">
          ...
          {preview ? (
            <div className="flex flex-col gap-3 border-t border-brand-dark/8 pt-4">
              <div className="overflow-hidden rounded-lg border border-brand-dark/10 bg-brand-bg">
                <img
                  src={preview.url}
                  alt=""
        ...
        <nav className="mt-8 flex flex-col gap-3 text-center text-sm">
          ...
          <Link to="/" className="text-brand-dark/60 hover:text-brand-dark/80">
            ← Startsidan
          </Link>
        </nav>
      </div>
